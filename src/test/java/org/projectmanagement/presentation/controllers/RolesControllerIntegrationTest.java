...
public class RolesControllerIntegrationTest {
    ...
    void setUp() {
        ...
        inMemoryDatabase.roles.add(new Roles(roleAdminId, "Admin", companyId, Instant.now(), Instant.now()));
        inMemoryDatabase.roles.add(new Roles(roleDeveloperId, "Developer", companyId, Instant.now(), Instant.now()));
        inMemoryDatabase.roles.add(new Roles(roleProjectDirectorId, "Team Leader", companyId, Instant.now(), Instant.now()));
